...
Late interaction uses token-level hidden states. The first implementation is an
exact MaxSim reranker over stored token blocks, intended for candidate sets from
aliases, FTS, graph neighborhoods, or pooled-vector search.
